...
BATCHSIZE = 3
CLASSES = 3
EPOCHS = 5 #need a model, ideally would run ~30 from prior knowledge, computationally too expensive
...
def objective(trial):
    ...
    train_ds, valid_ds, pred_ds = Dataset_from_directory(data_dir, predict_dir, 0.5)
...
if __name__ == "__main__":
    ...
    study.optimize(objective, n_trials=10) # past 3 trials found best in <5 trials
    sys.stdout = open('Hyperparam_output2.txt', 'w')
